    ...
    <section>
        ...
        <form method="post" action="<?= base_url('/update')?>">
            ...
            <input type="text" name="username" placeholder="Username" required
                style="width: 100%; max-width: 1000px; height: 50px; padding: 10px; font-size: 20px;
                margin-bottom: 15px; border-radius: 8px; border: 2px solid #ccc;"
                value="<?= esc($user['username']) ?>" /><br>

            <input type="email" name="email" placeholder="Email" required
                style="width: 100%; max-width: 1000px; height: 50px; padding: 10px; font-size: 20px;
                margin-bottom: 15px; border-radius: 8px; border: 2px solid #ccc;"
                value="<?= esc($user['email']) ?>" /><br>

            <input type="password" name="password" placeholder="Password" required
                style="width: 100%; max-width: 1000px; height: 50px; padding: 10px; font-size: 20px;
                margin-bottom: 15px; border-radius: 8px; border: 2px solid #ccc;"/><br>

            <button type="submit" style="width: 100%; max-width: 200px; height: 40px; font-size: 22px;
